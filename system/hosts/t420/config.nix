...
let
  ...
  dwlsrc = pkgs.fetchFromGitHub {
    ...
    repo = "dwl-v0.7";
    rev = "main";
    hash = "sha256-wAMSqIpwDCssH5/ZmYOZ9MBm3vK1TTOS27fyPbRQX1I=";
  };
  ...
  slstatussrc = pkgs.fetchFromGitHub {
    ...
    repo = "slstatus";
    rev = "main";
    hash = "sha256-EdUrPiIs9FY3gTrrR4aeti4tUuqA2fiXuPeIrCrOTaI=";
  };
  ...
  nixfetchsrc = pkgs.fetchFromGitHub {
    ...
    repo = "nixfetch";
    rev = "main";
    hash = "sha256-GCwAphCh4MY2x7nyHOvqB4jMH77QnhLbRHF8UB7R2Ms=";
  };
